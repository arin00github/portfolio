...
import Header from './Header/Header_m';
...
let Main = lazy(()=>{return import('./Main/Main_m')});
let About = lazy(()=>{return import('./About/About_m')});
let Web = lazy(()=>{return import('./Portfolio/Web_m')});
let Package = lazy(()=>{return import('./Portfolio/Package_m')});
let CSSEffect = lazy(()=>{return import('./Portfolio/Css_m')});
let Contact = lazy(()=>{return import('./Contact/Contact_m')});
